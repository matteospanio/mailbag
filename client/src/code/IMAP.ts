...
export class Worker {
  public async listMailboxes(): Promise<any> {
  ...
  public async listMessages(inMailbox: string): Promise<any> {
    const response: AxiosResponse = await axios.get(
  ...
  public async getMessageBody(inID: string, inMailbox: String): Promise<any> {
    const response: AxiosResponse = await axios.get(
